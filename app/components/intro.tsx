...
import Typewriter from "./Typewriter"; // Make sure this path is correct

const Intro = () => {
    const router = useRouter();

    // The typewriter will now cycle through all of these sentences
    const sentences = [
        "I design UI/UX & build High End Web Applications for startups.",
        "I bring interfaces to life with fluid Framer Motion animations.",
        "I engineer robust, scalable backends with NestJS and MongoDB."
    ];
    ...
    return ( 
        <div className="w-full flex flex-col justify-center items-center text-center gap-12 lg-gap-16 my-16 h-[90svh] lg:my-24" id="#">
            ...
            <div className="text-4xl w-10/12 lg:text-6xl font-serif flex justify-center items-center min-h-[150px] lg:min-h-[200px]">
